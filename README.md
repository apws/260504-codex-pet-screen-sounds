...
The Windows app launches without args, lives in the system tray, watches an 80x80 DIP rectangle at the bottom-left of the screen, and plays `C:\Windows\Media\ringout.wav` when the watched pixels change. Right-click the tray icon and choose `Exit` to stop it.
