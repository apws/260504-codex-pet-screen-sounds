...
- watches a 48x48 point rectangle near the bottom-left of the main display, offset 32 px from the left edge and 48 px from the bottom edge
...
```sh
open build/CodexPetWatch.app
build/CodexPetWatch.app/Contents/MacOS/CodexPetWatch --size=48x48
